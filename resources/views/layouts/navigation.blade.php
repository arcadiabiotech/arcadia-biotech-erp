        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('talukas.index')" :active="request()->routeIs('talukas.*')">
                        📍 Talukas
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }"
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link
                ...
                :active="request()->routeIs('states.*')">
                🌍 States
            </x-responsive-nav-link>

            <x-responsive-nav-link
                :href="route('districts.index')"
                :active="request()->routeIs('districts.*')">
                🏙 Districts
            </x-responsive-nav-link>

            <x-responsive-nav-link
                :href="route('talukas.index')"
                :active="request()->routeIs('talukas.*')">
                📍 Talukas
            </x-responsive-nav-link>

            <x-responsive-nav-link
                :href="route('dealers.index')"
                :active="request()->routeIs('dealers.*')">
                👨‍💼 Dealers
            </x-responsive-nav-link>
